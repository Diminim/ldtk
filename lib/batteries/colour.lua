...
function colour.oklab_to_rgb(l, a, b)
	...
	-- local red = ( 4.0767416621 * _l - 3.3077115913 * _m + 0.2309699292 * _s)
	-- local green = (-1.2684380046 * _l + 2.6097574011 * _m - 0.3413193965 * _s)
	-- local blue = (-0.0041960863 * _l - 0.7034186147 * _m + 1.7076147010 * _s)
...
function colour.rgb_to_oklab(red, green, blue)
	...
	local _l = 0.4122214708 * red + 0.5363325363 * green + 0.0514459929 * blue
	local _m = 0.2119034982 * red + 0.6806995451 * green + 0.1073969566 * blue
	local _s = 0.0883024619 * red + 0.2817188376 * green + 0.6299787005 * blue
...
function colour.oklch_to_rgb(l, c, h)
	local a = c*math.cos(h)
	local b = c*math.sin(h)

	return colour.oklab_to_rgb(l, a, b)
end

function colour.rgb_to_oklch(red, green, blue)
	local l, a, b = colour.rgb_to_oklab(red, green, blue)
